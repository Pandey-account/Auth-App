  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-6 py-10 dark:bg-black">
      ...
      <div
        className="
          absolute inset-0
          bg-[linear-gradient(to_right,rgba(120,120,120,0.05)_1px,transparent_1px),
          linear-gradient(to_bottom,rgba(120,120,120,0.05)_1px,transparent_1px)]
          bg-[size:60px_60px]
        "
      />
        ...
        <CardContent className="p-8">
          ...
          <div className="text-center">
            ...
            <h1
              className="
                bg-gradient-to-r
                from-black via-cyan-700 to-violet-700
                bg-clip-text
                text-4xl
                font-black
                text-transparent
